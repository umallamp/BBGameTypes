 ...
 */
public class RedBloodUnit implements BloodUnit {
    private final int quantity;
    private final int lifeInDays;

    public RedBloodUnit(int quantity, int lifeInDays) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RedBloodUnit)) {
            return false;
        }

        RedBloodUnit other = (RedBloodUnit) obj;
